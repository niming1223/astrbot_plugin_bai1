...
# 插件注册（ID保持唯一，名称适配）
@register("starcitizen_attr_plugin", "超时空星舰插件", "超时空星舰装备查询插件", "1.0.0")
...
def load(context: Context):
    return StarCitizenAttrPlugin(context)
